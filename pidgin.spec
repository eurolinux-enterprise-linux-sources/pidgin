...
# RH bug #575688
# XXX This was originally applied to pidgin-2.6.6 to cover all Red Hat
#     Supported Languages, but needs redone since we rebased in 6.1.
#Patch100: pidgin-2.6.6-el6-translation-updates.patch

# RH bug #683031
Patch101: pidgin-2.7.9-CVE-2011-1091.patch

# RH bug #684685
Patch102: pidgin-2.7.9-zero-out-crypto-keys.patch

# CVE-2011-4601
Patch103: pidgin-2.7.9-CVE-2011-4601.patch

# CVE-2011-4602
Patch104: pidgin-2.7.9-CVE-2011-4602.patch

# CVE-2012-1178
Patch105: pidgin-2.7.9-CVE-2012-1178.patch

# CVE-2012-2318
Patch106: pidgin-2.7.9-CVE-2012-2318.patch

# CVE-2012-3374
Patch107: pidgin-2.7.9-CVE-2012-3374.patch
...
## Patches 100+: To be Included in Future Upstream
#%patch100 -p1 -b .translation-updates
%patch101 -p1 -b .CVE-2011-1091
%patch102 -p1 -b .zero-out-crypto-keys
%patch103 -p1 -b .CVE-2011-4601
%patch104 -p1 -b .CVE-2011-4602
%patch105 -p1 -b .CVE-2012-1178
...
* Mon Dec 12 2011 Matthew Barnes <mbarnes@redhat.com> - 2.7.9-5.el6
- Add patch for CVE-2011-4602 (RH bug #766453).

* Mon Dec 12 2011 Matthew Barnes <mbarnes@redhat.com> - 2.7.9-4.el6
- Add patch for CVE-2011-4601 (RH bug #766453).

* Mon Mar 14 2011 Matthew Barnes <mbarnes@redhat.com> - 2.7.9-3.el6
- Add patch for RH bug #684685 (zero-out crypto keys before freeing).

* Fri Mar 11 2011 Matthew Barnes <mbarnes@redhat.com> - 2.7.9-2.el6
- Add patch for CVE-2011-1091 (RH bug #683031).

* Sun Jan 09 2011 Matthew Barnes <mbarnes@redhat.com> - 2.7.9-1.el6
